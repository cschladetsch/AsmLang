...
TESTS=(
  ...
  "ContinuationScopeIsolation|{ 5 'x # { x 1 + } & } &|1"
  ...
  "ContinuationWithVariables|5 { 'x # x 10 + } &|15"
  ...
  "ContinuationReplaceTailCall|{ 4 { 5 } ! } &|[4, 5]"
  "ContinuationScopeSnapshot|200 'y # { y { 100 'y # y } & y } &|[0, 100, 0]"
  ...
  "ContinuationVariable2|{ 2 'v # { v 1 + } & v } &|[1, 2]"
  "ContinuationVariable3|{ 3 'v # { v } & } &|0"
  "ContinuationSuspend1|{ 1 { 2 } & } &|[1, 2]"
  "ContinuationSuspend2|{ 1 { 2 } & ... } &|[1, 2]"
  "ContinuationSuspend3|{ 1 { 2 3 } & ... } &|[1, 2, 3]"
  "ContinuationReplace1|{ 1 { 2 } ! } &|[1, 2]"
  "ContinuationReplace2|{ 1 { 2 3 + } ! } &|[1, 5]"
  "ContinuationReplace3|{ 1 { 2 } ! 4 } &|[1, 2]"
  ...
  "ContinuationComplex1|{ 1 { 2 } & { 3 } & ... ... + } &|[1, 2, 3]"
  "ContinuationComplex2|{ 5 'x # { x 1 + } & x } &|[1, 5]"
  "ContinuationComplex3|{ { 5 } ! } &|5"
  "ContinuationComplex4|{ 1 { 2 } & clear 3 } &|3"
  "ContinuationComplex5|{ [1 2] { length } & } &|[[1 2], 0]"
)
